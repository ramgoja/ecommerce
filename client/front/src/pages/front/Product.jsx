            ...
            <div className="col-lg-5 col-md-12 mb-3">
              <div className="col-12 mb-3">
                <div
                  ...
                  style={{
                    backgroundImage: `url('${imgUrl(imgLarge)}')`,
                  }}
                ></div>
              </div>
              <div className="col-12">
                  ...
                  <div className="col-12">
                    <div className="row">
                      <div className="col-sm-4 text-center">
                        <div className="row">
                          <div className="col-12 average-rating">{rating}</div>
                  ...
                  <div className="col-12">
                    {Object.keys(user).length ? (
                      <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                          <SubmitBtn label="Add Review" icon="fa-plus" loading={loading} />
                        </div>
                      </form>
                    ) : (
                      <div className="col-12 text-center py-2 px-3 mb-3 bg-gray">
